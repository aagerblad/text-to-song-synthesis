...
public class Note {
    ...
    public static final Float[] NOTE_ARRAY = {C0, C_SHARP0, D0, D_SHARP0, E0, F0, F_SHARP0, G0, G_SHARP0, A0, A_SHARP0,
    ...
    public static final ArrayList<Float> NOTE_LIST = new ArrayList<Float>(Arrays.asList(NOTE_ARRAY));
